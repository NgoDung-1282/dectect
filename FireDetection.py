...
TELEGRAM_BOT_TOKEN = '6924332409:AAHWQD2hd6qjQKh9Fc9OtIPCfAZq4Woqwxg'
TELEGRAM_CHAT_ID = '5385980151'
...
class ObjectDetectionApp:
    ...
    def create_widgets(self):
        ...
        self.btn_close_webcam = Button(self.root, text="Quit", command=self.exit_camera,
                                       font=('Calibri', 14), bg='gray', fg='black')
            ...
            for info in result:
                ...
                for box in boxes:
                    ...
                    if Class < len(classnames) and confidence > 50:
                        ...
                        if not alert_sent:
                    # Send a Telegram message when fire or smoke is detected
                            message = '🔥 Fire Alert! 🔥: Detected by WEBCAM'
                            url = f"https://api.telegram.org/bot6924332409:AAHWQD2hd6qjQKh9Fc9OtIPCfAZq4Woqwxg/sendMessage?chat_id=5385980151&text={message}"
                            r = requests.get(url)
                            print(r.json())
